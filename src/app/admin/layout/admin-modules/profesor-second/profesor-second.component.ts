...
@Component({
  selector: 'app-profesor-second',
  templateUrl: './profesor-second.component.html',
  styleUrls: ['./profesor-second.component.scss']
})
export class ProfesorSecondComponent implements OnInit {
